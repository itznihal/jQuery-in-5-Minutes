...
// -> Why
// -> Syntax
// ->Document Ready -> Operatiion after fetch and render
// ->EVENTS
// ->AIMATIONS
// TARGET HTMML / DOM MAUPLATION -> AND SET 
// ANIMATION 
// EVENT
// ADD CSS 
// REMOER ELEMENT 
// CHENGE IN FORM ELEMENT 
// AND SAME OTHERTR STUFF AS REACT AND JAVASCRIPT


// READY FUNCTION-> APPLY JQUERY AFTER DOM IS COMPELETLY  FETCHED  AND READY 
$(document).ready(function () {
  ...
  //clicks on all the p elements.
    ...
    // demoing the on method-> USE MULTIPLE METHODS ON SINGLE ELEMENTS
    $('p').on(
        {
            click: function () {
